...
if __name__ =="__main__":
    ...
    for epoch in range(config.EPOCHS):
        print("here")
        train_loss = engine.train_fn(train_data_loader, model, device, optimizer, scheduler)
        test_loss = engine.eval_fn(valid_data_loader, model, device)
        print("train_loss = {train_loss}, Valid_loss = {test_loss}".format(train_loss=train_loss, test_loss = test_loss))
